package com.frederis.notsureifreading.widget;
...
public class AddStudentFABFrameLayout extends CheckableFrameLayout {
    private View mRevealView;
    private float mHotSpotX, mHotSpotY;
    private int mRevealViewOffColor;

    public AddStudentFABFrameLayout(Context context) {
        this(context, null, 0, 0);
    }

    public AddStudentFABFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0, 0);
    }

    public AddStudentFABFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public AddStudentFABFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
